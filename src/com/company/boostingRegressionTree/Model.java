package com.company.boostingRegressionTree;

import com.company.boostingRegressionTree.loss.Loss;
import com.company.boostingRegressionTree.loss.SquareLoss;
...
public class Model {
	...
	public static void main(String[] args) throws IOException, Exception {
		...
		ArrayList<Instance> dataset = Instance
				.loadDatasetAndSchema("D:\\Users\\tianchi_music\\p2\\DateArtistTest.csv");
//				ArrayList<TreeNode> model = train(dataset,3, 2400);
// 	  			 saveModel(model, outputModelPath);
		evaluate(outputModelPath, dataset, "D:\\Users\\tianchi_music\\DateArtistTestResult.csv");
	}
	...
	private static void evaluate(String modelPath, ArrayList<Instance> dataset,
		...
		for (int j = 0; j < dataset.size(); j++) {
			...
			System.out.println("预测值为"+probs[j] +"真实值为:"+trueValues[j]);
